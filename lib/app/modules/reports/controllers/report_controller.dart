...
class ReportController extends GetxController {
  ...
  Future<List<SalesReport>> fetchSalesReport(
  ...
  Future<void> generateSalesReportPdf(List<SalesReport> salesReports) async {
    ...
    final totalGeneral = salesReports.fold(0.0, (sum, report) => sum + report.lineTotal);
                ...
                children: [
                  pw.TableRow(
                    ...
                    children: [
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                        child: pw.Text('Precio (USD)', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                        child: pw.Text('Serial', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                        child: pw.Text('Total Línea (USD)', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                      ),
                    ],
                  ),
                  ...salesReports.map((report) => pw.TableRow(
                    children: [
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                        child: pw.Text(report.productPrice.toStringAsFixed(2)),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                  ...
                  pw.TableRow(
                    ...
                    children: [
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                        child: pw.Text('Total General', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                      ),
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                        child: pw.Text(totalGeneral.toStringAsFixed(2), style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                      ),
                    ],
                  ),
                ],
